      ...
      <div className="grid grid-cols-3 gap-6">
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-12 h-12 mx-auto mt-2 rounded-xl flex items-center justify-center text-xl ${
                      ...
                      {meals.length > 0 ? <span>&#x1F37D;</span> : <span className="text-gray-200 text-lg">-</span>}
                    </div>
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            <h3 className="font-bold text-gray-800 text-sm mb-3">Grocery Summary</h3>
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            <h3 className="font-bold text-gray-800 text-sm mb-3">Today's Meals</h3>
